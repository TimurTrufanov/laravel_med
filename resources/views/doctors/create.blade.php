    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Додавання лікаря</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Додавання лікаря</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('doctors.store') }}" method="POST" class="w-50"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                       name="first_name"
                                       placeholder="Ім'я" value="{{ old('first_name') }}">
                            </div>
                            @error('first_name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                       name="last_name"
                                       placeholder="Прізвище" value="{{ old('last_name') }}">
                            </div>
                            @error('last_name')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select name="gender" class="form-control @error('gender') is-invalid @enderror">
                                    ...
                                    <option value="чоловічий" {{ old('gender') == 'чоловічий' ? 'selected' : '' }}>
                                        Чоловіча
                                    </option>
                                    <option value="жіночий" {{ old('gender') == 'жіночий' ? 'selected' : '' }}>
                                        Жіноча
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('address') is-invalid @enderror"
                                       name="address"
                                       placeholder="Адреса" value="{{ old('address') }}">
                            </div>
                            @error('address')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone_number') is-invalid @enderror"
                                       name="phone_number"
                                       placeholder="Номер телефону" value="{{ old('phone_number') }}">
                            </div>
                            @error('phone_number')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select id="specializations" name="specializations[]" multiple="multiple"
                                        class="form-control select2 @error('specializations') is-invalid @enderror"
                                        data-placeholder="Виберіть спеціалізації">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('position') is-invalid @enderror"
                                       name="position"
                                       placeholder="Посада" value="{{ old('position') }}">
                            </div>
                            @error('position')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none;"
                                          ...
                                          placeholder="Біографія" rows="3">{{ old('bio') }}</textarea>
                            </div>
                            @error('bio')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('appointment_duration') }}" min="5" max="60" step="5">
                            </div>
                            @error('appointment_duration')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror

                            <input type="submit" class="btn btn-primary mb-4" value="Додати">
                        </form>
                    </div>
                </div>
            </div>
