    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Редагування клініки</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ route('clinics.update', $clinic->id) }}" method="POST" class="w-50">
                            @csrf
                            @method('PATCH')
                            <div class="form-group">
                                <label>Назва <span style="color: red;">*</span></label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                       placeholder="Назва клініки" value="{{ old('name', $clinic->name) }}">
                            </div>
                            @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('region') is-invalid @enderror"
                                       placeholder="Регіон" name="region" value="{{ old('region', $clinic->region) }}">
                            </div>
                            @error('region')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('city') is-invalid @enderror" name="city"
                                       placeholder="Місто" value="{{ old('city', $clinic->city) }}">
                            </div>
                            @error('city')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('address') is-invalid @enderror"
                                       placeholder="Адреса" name="address"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                       placeholder="Email" name="email" value="{{ old('email', $clinic->email) }}">
                            </div>
                            @error('email')
                            <div class="text-danger mb-3">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select name="specializations[]" class="form-control select2" multiple="multiple"
