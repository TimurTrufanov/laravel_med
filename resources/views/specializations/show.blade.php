            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        <h1 class="m-0 mr-2">{{ $specialization->name }}</h1>
                        <a href="{{ route('specializations.edit', $specialization->id) }}" class="text-success mr-2"><i
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('specializations.index') }}">
                                    Спеціалізації
                                </a>
                            </li>
